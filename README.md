...
## Theme: POE
���������ߴ��λ�ã�
- ��ɫ��`wuxing_board/board_render.py` -> `ELEMENT_COLORS`
- �ڵ��С/��״/��ߣ�`wuxing_board/board_render.py` -> `NODE_STYLE`
- ���������Ȩ�أ�`wuxing_board/board_render.py` -> `halo_alpha/halo_boost` ����� alpha/width
- �����ߴ磺`unified_interface_modules.py` -> `render_wuxing_board_interface()` �� `height=780` / `override_height=780`
